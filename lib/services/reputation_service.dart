...
class ReputationService {
  ...
  Future<CallReputation?> checkNumber(
    ...
    try {
      ...
      AppLogger.error(LogCategory.network, 'Error checking reputation: $e');
      return null;
    }
  }
  ...
  Future<bool> reportNumber(
    ...
    try {
      ...
      AppLogger.error(LogCategory.network, 'Error reporting number: $e');
      return false;
    }
  }
  ...
  Future<Map<String, dynamic>?> getReportStats() async {
    try {
      ...
      AppLogger.error(LogCategory.network, 'Error fetching report stats: $e');
      return null;
    }
  }
